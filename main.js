...
var _w0rm$elm_flatris$Actions$Wait = {ctor: 'Wait'};
var _w0rm$elm_flatris$Actions$Noop = {ctor: 'Noop'};
var _w0rm$elm_flatris$Actions$Accelerate = function (a) {
	return {ctor: 'Accelerate', _0: a};
};
var _w0rm$elm_flatris$Actions$Rotate = function (a) {
	return {ctor: 'Rotate', _0: a};
};
var _w0rm$elm_flatris$Actions$MoveRight = function (a) {
	return {ctor: 'MoveRight', _0: a};
};
var _w0rm$elm_flatris$Actions$MoveLeft = function (a) {
	return {ctor: 'MoveLeft', _0: a};
};
var _w0rm$elm_flatris$Actions$UnlockButtons = {ctor: 'UnlockButtons'};
var _w0rm$elm_flatris$Actions$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _w0rm$elm_flatris$Actions$Resume = {ctor: 'Resume'};
var _w0rm$elm_flatris$Actions$Pause = {ctor: 'Pause'};
var _w0rm$elm_flatris$Actions$InitMultiplayer = {ctor: 'InitMultiplayer'};
var _w0rm$elm_flatris$Actions$Stop = {ctor: 'Stop'};
var _w0rm$elm_flatris$Actions$Start = {ctor: 'Start'};
var _w0rm$elm_flatris$Actions$Load = function (a) {
	return {ctor: 'Load', _0: a};
};
var _w0rm$elm_flatris$Actions$Init = {ctor: 'Init'};

var _w0rm$elm_flatris$Grid$encode = F2(
	function (cell, grid) {
...
var _w0rm$elm_flatris$Grid$centerOfMass = function (grid) {
...
var _w0rm$elm_flatris$Grid$initPosition = F2(
	function (wid, grid) {
		var y = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			_elm_lang$core$List$maximum(
				A2(
					...
					grid)));
		var _p5 = _w0rm$elm_flatris$Grid$centerOfMass(grid);
		var x = _p5._0;
		return {ctor: '_Tuple2', _0: ((wid / 2) | 0) - x, _1: (0 - y) - 1};
	});
var _w0rm$elm_flatris$Grid$size = function (grid) {
...
var _w0rm$elm_flatris$Grid$fullLine = F2(
	function (wid, grid) {
		fullLine:
		while (true) {
			var _p7 = grid;
...
var _w0rm$elm_flatris$Grid$clearLines = F2(
	function (wid, grid) {
		var _p11 = A2(_w0rm$elm_flatris$Grid$fullLine, wid, grid);
		if (_p11.ctor === 'Nothing') {
			...
			var droppedAbove = A2(
				...
				above);
			var _p17 = A2(
				_w0rm$elm_flatris$Grid$clearLines,
				wid,
...
var _w0rm$elm_flatris$Grid$collide = F6(
...
var _w0rm$elm_flatris$Grid$stamp = F4(
...
var _w0rm$elm_flatris$Grid$rotate = F2(
	function (clockwise, grid) {
		var _p26 = _w0rm$elm_flatris$Grid$centerOfMass(grid);
		var x = _p26._0;
		var y = _p26._1;
...
var _w0rm$elm_flatris$Grid$empty = {ctor: '[]'};
var _w0rm$elm_flatris$Grid$mapToList = function (fun) {
...
var _w0rm$elm_flatris$Grid$Cell = F2(
	function (a, b) {
		return {val: a, pos: b};
	});
var _w0rm$elm_flatris$Grid$fromList = function (value) {
	return _elm_lang$core$List$map(
		_w0rm$elm_flatris$Grid$Cell(value));
};
var _w0rm$elm_flatris$Grid$decode = function (cell) {
	return _elm_lang$core$Json_Decode$list(
		A3(
			_elm_lang$core$Json_Decode$map2,
			_w0rm$elm_flatris$Grid$Cell,
...
var _w0rm$elm_flatris$LocalStorage$remove = function (key) {
	return _w0rm$elm_flatris$Native_LocalStorage.remove;
};
var _w0rm$elm_flatris$LocalStorage$set = _w0rm$elm_flatris$Native_LocalStorage.set;
var _w0rm$elm_flatris$LocalStorage$get = _w0rm$elm_flatris$Native_LocalStorage.get;
var _w0rm$elm_flatris$LocalStorage$UnexpectedPayload = function (a) {
	return {ctor: 'UnexpectedPayload', _0: a};
};
var _w0rm$elm_flatris$LocalStorage$fromJson = F2(
	function (decoder, str) {
		...
		if (_p0.ctor === 'Ok') {
			...
			return _elm_lang$core$Task$fail(
				_w0rm$elm_flatris$LocalStorage$UnexpectedPayload(_p0._0));
		}
	});
var _w0rm$elm_flatris$LocalStorage$getJson = F2(
	function (decoder, key) {
		var decode = function (maybe) {
			var _p1 = maybe;
			if (_p1.ctor === 'Just') {
				return A2(_w0rm$elm_flatris$LocalStorage$fromJson, decoder, _p1._0);
			} else {
		...
		return A2(
			_elm_lang$core$Task$andThen,
			decode,
			_w0rm$elm_flatris$LocalStorage$get(key));
	});
var _w0rm$elm_flatris$LocalStorage$NoStorage = {ctor: 'NoStorage'};

var _w0rm$elm_flatris$Model_ops = _w0rm$elm_flatris$Model_ops || {};
_w0rm$elm_flatris$Model_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _w0rm$elm_flatris$Model$encodeColor = function (color) {
	return function (_p0) {
		var _p1 = _p0;
		return _elm_lang$core$Json_Encode$list(
			A2(
...
var _w0rm$elm_flatris$Model$encode = F2(
			...
			_elm_lang$core$Json_Encode$object(
				{
					ctor: '::',
					_0: A2(
						_w0rm$elm_flatris$Model_ops['=>'],
						'active',
						A2(_w0rm$elm_flatris$Grid$encode, _w0rm$elm_flatris$Model$encodeColor, model.active)),
					_1: {
						ctor: '::',
						_0: A2(
							_w0rm$elm_flatris$Model_ops['=>'],
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									_w0rm$elm_flatris$Model_ops['=>'],
									'grid',
									A2(_w0rm$elm_flatris$Grid$encode, _w0rm$elm_flatris$Model$encodeColor, model.grid)),
								_1: {
									ctor: '::',
									_0: A2(
										_w0rm$elm_flatris$Model_ops['=>'],
									...
									_1: {
										...
										_0: A2(
											_w0rm$elm_flatris$Model_ops['=>'],
											'next',
											A2(_w0rm$elm_flatris$Grid$encode, _w0rm$elm_flatris$Model$encodeColor, model.next)),
										_1: {
											ctor: '::',
											_0: A2(
												_w0rm$elm_flatris$Model_ops['=>'],
											...
											_1: {
												...
												_0: A2(
													...
													_elm_lang$core$Json_Encode$string(
														_w0rm$elm_flatris$Model$encodeState(model.state))),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _w0rm$elm_flatris$Model$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {active: a, position: b, grid: c, lines: d, next: e, score: f, seed: g, state: h, acceleration: i, moveLeft: j, moveRight: k, direction: l, rotation: m, width: n, height: o, multiplayer: p, winner: q};
																};
															};
														};
													};
...
var _w0rm$elm_flatris$Model$Waiting = {ctor: 'Waiting'};
var _w0rm$elm_flatris$Model$Stopped = {ctor: 'Stopped'};
var _w0rm$elm_flatris$Model$initial = {
	active: _w0rm$elm_flatris$Grid$empty,
	position: {ctor: '_Tuple2', _0: 0, _1: 0},
	grid: _w0rm$elm_flatris$Grid$empty,
	lines: 0,
	next: _w0rm$elm_flatris$Grid$empty,
	score: 0,
	seed: _elm_lang$core$Random$initialSeed(0),
	state: _w0rm$elm_flatris$Model$Stopped,
	acceleration: false,
	moveLeft: false,
	moveRight: false,
...
var _w0rm$elm_flatris$Model$Playing = {ctor: 'Playing'};
var _w0rm$elm_flatris$Model$Paused = {ctor: 'Paused'};
var _w0rm$elm_flatris$Model$decodeState = function (string) {
	var _p3 = string;
	switch (_p3) {
		case 'paused':
			return _w0rm$elm_flatris$Model$Paused;
		case 'playing':
			return _w0rm$elm_flatris$Model$Playing;
		default:
			return _w0rm$elm_flatris$Model$Stopped;
	}
};
var _w0rm$elm_flatris$Model$decode = F2(
				...
				active: A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Json_Decode$field,
							'active',
							_w0rm$elm_flatris$Grid$decode(_w0rm$elm_flatris$Model$decodeColor)),
						string)),
				position: {
					ctor: '_Tuple2',
					_0: A2(
				...
				state: A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Json_Decode$field,
							'state',
							A2(_elm_lang$core$Json_Decode$map, _w0rm$elm_flatris$Model$decodeState, _elm_lang$core$Json_Decode$string)),
						string))
			});
	});

var _w0rm$elm_flatris$Tetriminos$tetriminos = A2(
	_elm_lang$core$List$map,
	_elm_lang$core$Basics$uncurry(_w0rm$elm_flatris$Grid$fromList),
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _w0rm$elm_flatris$Tetriminos$random = function (seed) {
	var tetrimino = function (n) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_w0rm$elm_flatris$Grid$empty,
			_elm_lang$core$List$head(
				A2(_elm_lang$core$List$drop, n, _w0rm$elm_flatris$Tetriminos$tetriminos)));
	};
	var number = A2(
		_elm_lang$core$Random$int,
		0,
		_elm_lang$core$List$length(_w0rm$elm_flatris$Tetriminos$tetriminos) - 1);
	return A2(
		_elm_lang$core$Random$step,
...
var _w0rm$elm_flatris$Port$setState = _elm_lang$core$Native_Platform.outgoingPort(
	'setState',
	function (v) {
		return v;
	});
var _w0rm$elm_flatris$Port$responseCheckState = _elm_lang$core$Native_Platform.incomingPort('responseCheckState', _elm_lang$core$Json_Decode$bool);
var _w0rm$elm_flatris$Port$checkState = _elm_lang$core$Native_Platform.outgoingPort(
	'checkState',
	function (v) {
		return null;
	});
var _w0rm$elm_flatris$Port$onStateChanged = _elm_lang$core$Native_Platform.incomingPort('onStateChanged', _elm_lang$core$Json_Decode$string);

var _w0rm$elm_flatris$Update$level = function (model) {
	return ((model.lines / 10) | 0) + 1;
};
var _w0rm$elm_flatris$Update$clearLines = function (model) {
	var _p0 = A2(_w0rm$elm_flatris$Grid$clearLines, model.width, model.grid);
	var grid = _p0._0;
	var lines = _p0._1;
	var bonus = function () {
		var _p1 = lines;
	...
	return _elm_lang$core$Native_Utils.update(
		...
		{
			grid: grid,
			score: model.score + (bonus * _w0rm$elm_flatris$Update$level(model)),
			lines: model.lines + lines
		});
};
var _w0rm$elm_flatris$Update$checkEndGame = function (model) {
	return A2(
		_elm_lang$core$List$any,
		_elm_lang$core$Basics$identity,
		A2(
			_w0rm$elm_flatris$Grid$mapToList,
			F2(
				function (_p3, _p2) {
					var _p4 = _p2;
		...
		model,
		{state: _w0rm$elm_flatris$Model$Stopped}) : model;
};
var _w0rm$elm_flatris$Update$rotateTetrimino_ = function (model) {
	var rotated = A2(_w0rm$elm_flatris$Grid$rotate, true, model.active);
	...
	var shiftPosition = function (deltas) {
		...
		while (true) {
			...
			if (_p6.ctor === '::') {
				var _p7 = _p6._0;
				if (A6(
					_w0rm$elm_flatris$Grid$collide,
					model.width,
					model.height,
					x + _p7,
...
var _w0rm$elm_flatris$Update$activateButton = F3(
...
var _w0rm$elm_flatris$Update$rotateTetrimino = F2(
	function (elapsed, model) {
		var _p8 = model.rotation;
		if (_p8.ctor === 'Just') {
			var _p9 = _p8._0;
			return (_p9.active ? _w0rm$elm_flatris$Update$rotateTetrimino_ : _elm_lang$core$Basics$identity)(
				_elm_lang$core$Native_Utils.update(
					model,
					{
						rotation: _elm_lang$core$Maybe$Just(
							A3(_w0rm$elm_flatris$Update$activateButton, 300, elapsed, _p9))
					}));
		} else {
			return model;
		}
	});
var _w0rm$elm_flatris$Update$moveTetrimino_ = F2(
	function (dx, model) {
...
var _w0rm$elm_flatris$Update$direction = function (_p11) {
	var _p12 = _p11;
...
var _w0rm$elm_flatris$Update$startMove = function (model) {
	return (!_elm_lang$core$Native_Utils.eq(
		_w0rm$elm_flatris$Update$direction(model),
...
var _w0rm$elm_flatris$Update$moveTetrimino = F2(
	function (elapsed, model) {
		var _p14 = model.direction;
		if (_p14.ctor === 'Just') {
			var _p15 = _p14._0;
			return (_p15.active ? _w0rm$elm_flatris$Update$moveTetrimino_(
				_w0rm$elm_flatris$Update$direction(model)) : _elm_lang$core$Basics$identity)(
				_elm_lang$core$Native_Utils.update(
					model,
					{
						direction: _elm_lang$core$Maybe$Just(
							A3(_w0rm$elm_flatris$Update$activateButton, 150, elapsed, _p15))
					}));
		} else {
			return model;
		}
	});
var _w0rm$elm_flatris$Update$spawnTetrimino = function (model) {
	var _p16 = A2(_w0rm$elm_flatris$Grid$initPosition, model.width, model.next);
	var x = _p16._0;
	var y = _p16._1;
	var _p17 = _w0rm$elm_flatris$Tetriminos$random(model.seed);
	var next = _p17._0;
	var seed = _p17._1;
	return _elm_lang$core$Native_Utils.update(
		model,
...
var _w0rm$elm_flatris$Update$dropTetrimino = F2(
	function (elapsed, model) {
		var speed = model.acceleration ? 25 : A2(
			_elm_lang$core$Basics$max,
			25,
			800 - (25 * _elm_lang$core$Basics$toFloat(
				_w0rm$elm_flatris$Update$level(model) - 1)));
		...
		if (A6(
			...
			var score = _elm_lang$core$List$length(
				A2(
					...
					model.active));
			return _w0rm$elm_flatris$Update$clearLines(
				_w0rm$elm_flatris$Update$spawnTetrimino(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							grid: A4(
								_w0rm$elm_flatris$Grid$stamp,
								x,
								_elm_lang$core$Basics$floor(y),
								model.active,
								model.grid),
...
var _w0rm$elm_flatris$Update$animate = F2(
	function (elapsed, model) {
		return _w0rm$elm_flatris$Update$checkEndGame(
			A2(
				_w0rm$elm_flatris$Update$dropTetrimino,
				elapsed,
				A2(
					_w0rm$elm_flatris$Update$rotateTetrimino,
					elapsed,
					A2(_w0rm$elm_flatris$Update$moveTetrimino, elapsed, model))));
	});
var _w0rm$elm_flatris$Update$setState = function (state) {
	return _w0rm$elm_flatris$Port$setState(
		_w0rm$elm_flatris$Model$encodeState(state));
};
var _w0rm$elm_flatris$Update$saveToStorage = function (model) {
	return A2(
		F2(
			function (v0, v1) {
				return {ctor: '_Tuple2', _0: v0, _1: v1};
		...
		A2(
			...
			_elm_lang$core$Basics$always(_w0rm$elm_flatris$Actions$Noop),
			A2(
				_w0rm$elm_flatris$LocalStorage$set,
				'elm-flatris',
				A2(_w0rm$elm_flatris$Model$encode, 0, model))));
};
var _w0rm$elm_flatris$Update$getFromStorage = A2(
	_elm_lang$core$Task$attempt,
	function (result) {
		var _p22 = result;
		if (_p22.ctor === 'Ok') {
			return _w0rm$elm_flatris$Actions$Load(
				A2(_elm_lang$core$Maybe$withDefault, '', _p22._0));
		} else {
			return _w0rm$elm_flatris$Actions$Load('');
		}
	},
	_w0rm$elm_flatris$LocalStorage$get('elm-flatris'));
var _w0rm$elm_flatris$Update$update = F2(
	function (action, model) {
		var _p23 = action;
		switch (_p23.ctor) {
			case 'Init':
				var _p24 = _w0rm$elm_flatris$Tetriminos$random(
					_elm_lang$core$Random$initialSeed(0));
				var next = _p24._0;
				var seed = _p24._1;
				return {
					ctor: '_Tuple2',
					_0: _w0rm$elm_flatris$Update$spawnTetrimino(
						_elm_lang$core$Native_Utils.update(
							model,
							{seed: seed, next: next})),
					_1: _w0rm$elm_flatris$Update$getFromStorage
				};
			case 'Load':
				return {
					ctor: '_Tuple2',
					_0: A2(_w0rm$elm_flatris$Model$decode, _p23._0, model),
			...
			case 'Start':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{state: _w0rm$elm_flatris$Model$Playing, lines: 0, score: 0, grid: _w0rm$elm_flatris$Grid$empty, multiplayer: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'InitMultiplayer':
				var _p25 = A2(_w0rm$elm_flatris$Grid$initPosition, model.width, model.next);
				var x = _p25._0;
				var y = _p25._1;
				return {
					ctor: '_Tuple2',
					...
					_1: _w0rm$elm_flatris$Port$checkState(
						{ctor: '_Tuple0'})
				};
			case 'Wait':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{state: _w0rm$elm_flatris$Model$Waiting}),
					_1: _w0rm$elm_flatris$Update$setState(_w0rm$elm_flatris$Model$Waiting)
				};
			case 'Pause':
				return model.multiplayer ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{state: _w0rm$elm_flatris$Model$Paused}),
					_1: _w0rm$elm_flatris$Update$setState(_w0rm$elm_flatris$Model$Paused)
				} : _w0rm$elm_flatris$Update$saveToStorage(
					_elm_lang$core$Native_Utils.update(
						model,
						{state: _w0rm$elm_flatris$Model$Paused}));
			case 'Resume':
				return model.multiplayer ? {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{state: _w0rm$elm_flatris$Model$Playing}),
					_1: _w0rm$elm_flatris$Update$setState(_w0rm$elm_flatris$Model$Playing)
				} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'Stop':
				return _elm_lang$core$Native_Utils.eq(model.state, _w0rm$elm_flatris$Model$Stopped) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{state: _w0rm$elm_flatris$Model$Stopped, winner: true}),
					_1: _w0rm$elm_flatris$Update$setState(_w0rm$elm_flatris$Model$Stopped)
				};
			case 'MoveLeft':
				return {
					ctor: '_Tuple2',
					_0: _w0rm$elm_flatris$Update$startMove(
						_elm_lang$core$Native_Utils.update(
							model,
							{moveLeft: _p23._0})),
					_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'Tick':
				var newmodel = A2(
					_w0rm$elm_flatris$Update$animate,
					A2(_elm_lang$core$Basics$min, _p23._0, 25),
					model);
				return newmodel.multiplayer ? (_elm_lang$core$Native_Utils.eq(newmodel.state, _w0rm$elm_flatris$Model$Stopped) ? {
					ctor: '_Tuple2',
					_0: newmodel,
					_1: _w0rm$elm_flatris$Update$setState(_w0rm$elm_flatris$Model$Stopped)
				} : {ctor: '_Tuple2', _0: newmodel, _1: _elm_lang$core$Platform_Cmd$none}) : _w0rm$elm_flatris$Update$saveToStorage(newmodel);
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});

var _w0rm$elm_flatris$View$renderBox = F4(
...
var _w0rm$elm_flatris$View$renderNext = function (grid) {
	var _p4 = _w0rm$elm_flatris$Grid$size(grid);
	var width = _p4._0;
	var height = _p4._1;
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			A2(
				_w0rm$elm_flatris$Grid$mapToList,
				A2(
					_w0rm$elm_flatris$View$renderBox,
					{
						ctor: '_Tuple2',
...
var _w0rm$elm_flatris$View$renderWell = function (_p5) {
	var _p6 = _p5;
	var _p9 = _p6.width;
...
var _w0rm$elm_flatris$View$onTouchEnd = function (action) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'touchend',
		_elm_lang$core$Json_Decode$succeed(action));
};
var _w0rm$elm_flatris$View$onTouchStart = function (action) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'touchstart',
		_elm_lang$core$Json_Decode$succeed(action));
};
var _w0rm$elm_flatris$View_ops = _w0rm$elm_flatris$View_ops || {};
_w0rm$elm_flatris$View_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _w0rm$elm_flatris$View$renderTitle = function (txt) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#34495f'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '40px'),
						_1: {
							ctor: '::',
							_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '60px'),
							_1: {
								ctor: '::',
								_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', '30px 0 0'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _w0rm$elm_flatris$View$renderLabel = function (txt) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#bdc3c7'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-weight', '300'),
						_1: {
							ctor: '::',
							_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '1'),
							_1: {
								ctor: '::',
								_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', '30px 0 0'),
								_1: {ctor: '[]'}
...
var _w0rm$elm_flatris$View$renderCount = function (n) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#3993d0'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '30px'),
						_1: {
							ctor: '::',
							_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '1'),
							_1: {
								ctor: '::',
								_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', '5px 0 0'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _w0rm$elm_flatris$View$renderMultiplayerGameButton = function (state) {
	var _p10 = {ctor: '_Tuple2', _0: 'New multiplayer game', _1: _w0rm$elm_flatris$Actions$InitMultiplayer};
	var txt = _p10._0;
	var action = _p10._1;
	return A2(
		_elm_lang$html$Html$button,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'background', '#34495f'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'border', '0'),
						_1: {
							ctor: '::',
							_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'bottom', '30px'),
							_1: {
								ctor: '::',
								_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#fff'),
								_1: {
									ctor: '::',
									_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'cursor', 'pointer'),
									_1: {
										ctor: '::',
										_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
										_1: {
											ctor: '::',
											_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '18px'),
											_1: {
												ctor: '::',
												_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-weight', '300'),
												_1: {
													ctor: '::',
													_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '60px'),
													_1: {
														ctor: '::',
														_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '160px'),
														_1: {
															ctor: '::',
															_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '60px'),
															_1: {
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'absolute'),
																		_1: {
																			ctor: '::',
																			_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '240px'),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					_w0rm$elm_flatris$View_ops['=>'],
																					'display',
																					_elm_lang$core$Native_Utils.eq(state, _w0rm$elm_flatris$Model$Stopped) ? 'block' : 'none'),
																				_1: {ctor: '[]'}
																			}
																		}
																	}
...
var _w0rm$elm_flatris$View$renderGameButton = function (state) {
	var _p11 = function () {
		var _p12 = state;
		switch (_p12.ctor) {
			case 'Stopped':
				return {ctor: '_Tuple2', _0: 'New game', _1: _w0rm$elm_flatris$Actions$Start};
			case 'Playing':
				return {ctor: '_Tuple2', _0: 'Pause', _1: _w0rm$elm_flatris$Actions$Pause};
			case 'Paused':
				return {ctor: '_Tuple2', _0: 'Resume', _1: _w0rm$elm_flatris$Actions$Resume};
			default:
				return {ctor: '_Tuple2', _0: 'Waiting player..', _1: _w0rm$elm_flatris$Actions$Noop};
		}
	}();
	var txt = _p11._0;
	var action = _p11._1;
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'display', 'block'),
										_1: {
											ctor: '::',
											_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '30px'),
															_1: {
																ctor: '::',
																_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '60px'),
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_1: {
																				ctor: '::',
																				_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '120px'),
																				_1: {ctor: '[]'}
																			}
																		}
																	}
...
var _w0rm$elm_flatris$View$renderPanel = function (_p13) {
	var _p14 = _p13;
	var _p15 = _p14.state;
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'bottom', '80px'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#34495f'),
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '14px'),
								_1: {
									ctor: '::',
									_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '300px'),
									_1: {
										ctor: '::',
										_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '0 30px'),
										_1: {
											ctor: '::',
											_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'absolute'),
											_1: {
												ctor: '::',
												_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'right', '0'),
												_1: {
													ctor: '::',
													_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'top', '0'),
													_1: {ctor: '[]'}
												}
											}
										}
		...
		{
			ctor: '::',
			_0: _w0rm$elm_flatris$View$renderTitle('Flatris'),
			_1: {
				ctor: '::',
				_0: _w0rm$elm_flatris$View$renderLabel('Score'),
				_1: {
					ctor: '::',
					_0: _w0rm$elm_flatris$View$renderCount(_p14.score),
					_1: {
						ctor: '::',
						_0: _w0rm$elm_flatris$View$renderLabel('Lines Cleared'),
						_1: {
							ctor: '::',
							_0: _w0rm$elm_flatris$View$renderCount(_p14.lines),
							_1: {
								ctor: '::',
								_0: _w0rm$elm_flatris$View$renderLabel('Next Shape'),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
										{
											...
											_0: _elm_lang$html$Html_Attributes$style(
												{
													ctor: '::',
													_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'margin-top', '10px'),
													_1: {
														ctor: '::',
														_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'relative'),
														_1: {ctor: '[]'}
													}
												}),
											_1: {ctor: '[]'}
										...
										{
											ctor: '::',
											_0: _w0rm$elm_flatris$View$renderNext(_p14.next),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _w0rm$elm_flatris$View$renderMultiplayerGameButton(_p15),
												_1: {
													ctor: '::',
													_0: _w0rm$elm_flatris$View$renderGameButton(_p15),
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
...
var _w0rm$elm_flatris$View$renderControlButton = F2(
	function (txt, attrs) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'background', '#ecf0f1'),
						_1: {
							ctor: '::',
							_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'border', '0'),
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'text-align', 'center'),
										_1: {
											ctor: '::',
											_0: A2(_w0rm$elm_flatris$View_ops['=>'], '-webkit-user-select', 'none'),
											_1: {
												ctor: '::',
												_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'display', 'block'),
												_1: {
													ctor: '::',
													_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'float', 'left'),
													_1: {
														ctor: '::',
														_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
														_1: {
															ctor: '::',
															_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '24px'),
															_1: {
																ctor: '::',
																_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'font-weight', '300'),
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', '20px 20px 0 0'),
																			_1: {
																				ctor: '::',
																				_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'outline', 'none'),
																				_1: {
																					...
																					_1: {
																						ctor: '::',
																						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '60px'),
																						_1: {ctor: '[]'}
																					}
																				}
																			}
...
var _w0rm$elm_flatris$View$renderControls = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$style(
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '0'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'absolute'),
						_1: {
							ctor: '::',
							_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'top', '600px'),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	},
	{
		ctor: '::',
		_0: A2(
			_w0rm$elm_flatris$View$renderControlButton,
			'↻',
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onMouseDown(
					_w0rm$elm_flatris$Actions$Rotate(true)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onMouseUp(
						_w0rm$elm_flatris$Actions$Rotate(false)),
					_1: {
						ctor: '::',
						_0: _w0rm$elm_flatris$View$onTouchStart(
							_w0rm$elm_flatris$Actions$Rotate(true)),
						_1: {
							ctor: '::',
							_0: _w0rm$elm_flatris$View$onTouchEnd(
								_w0rm$elm_flatris$Actions$Rotate(false)),
							_1: {ctor: '[]'}
						}
					}
		...
		_1: {
			...
			_0: A2(
				...
				'←',
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onMouseDown(
						_w0rm$elm_flatris$Actions$MoveLeft(true)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onMouseUp(
							_w0rm$elm_flatris$Actions$MoveLeft(false)),
						_1: {
							ctor: '::',
							_0: _w0rm$elm_flatris$View$onTouchStart(
								_w0rm$elm_flatris$Actions$MoveLeft(true)),
			...
			_1: {
				...
				_0: A2(
					...
					'→',
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onMouseDown(
							_w0rm$elm_flatris$Actions$MoveRight(true)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onMouseUp(
								_w0rm$elm_flatris$Actions$MoveRight(false)),
							_1: {
								ctor: '::',
								_0: _w0rm$elm_flatris$View$onTouchStart(
									_w0rm$elm_flatris$Actions$MoveRight(true)),
				...
				_1: {
					...
					_0: A2(
						...
						'↓',
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onMouseDown(
								_w0rm$elm_flatris$Actions$Accelerate(true)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onMouseUp(
									_w0rm$elm_flatris$Actions$Accelerate(false)),
								_1: {
									ctor: '::',
									_0: _w0rm$elm_flatris$View$onTouchStart(
										_w0rm$elm_flatris$Actions$Accelerate(true)),
...
var _w0rm$elm_flatris$View$renderInfo = function (state) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'background', 'rgba(236, 240, 241, 0.85)'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#34495f'),
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '600px'),
									_1: {
										ctor: '::',
										_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '0'),
										_1: {
											ctor: '::',
											_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '1.5'),
											_1: {
												ctor: '::',
												_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '0 15px'),
												_1: {
													ctor: '::',
													_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'absolute'),
													_1: {
														...
														_1: {
															ctor: '::',
															_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '270px'),
															_1: {
																ctor: '::',
																_0: A2(
																	_w0rm$elm_flatris$View_ops['=>'],
																	'display',
																	_elm_lang$core$Native_Utils.eq(state, _w0rm$elm_flatris$Model$Playing) ? 'none' : 'block'),
																_1: {ctor: '[]'}
															}
														}
													}
...
var _w0rm$elm_flatris$View$renderWinner = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '75px'),
									_1: {
										ctor: '::',
										_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '330px'),
										_1: {
											ctor: '::',
											_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '1.5'),
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '345px'),
															_1: {
																ctor: '::',
																_0: A2(
																	_w0rm$elm_flatris$View_ops['=>'],
																	'display',
																	(_elm_lang$core$Native_Utils.eq(model.state, _w0rm$elm_flatris$Model$Stopped) && model.multiplayer) ? 'block' : 'none'),
																_1: {ctor: '[]'}
															}
														}
													}
		...
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				model.winner ? 'You Win!!!' : 'You Loose...'),
			_1: {ctor: '[]'}
		});
};
var _w0rm$elm_flatris$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '30px 0'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _w0rm$elm_flatris$View$onTouchEnd(_w0rm$elm_flatris$Actions$UnlockButtons),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onMouseUp(_w0rm$elm_flatris$Actions$UnlockButtons),
					_1: {ctor: '[]'}
				}
			}
		},
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '680px'),
							_1: {
								ctor: '::',
								_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', 'auto'),
								_1: {
									ctor: '::',
									_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'relative'),
									_1: {
										ctor: '::',
										_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '480px'),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				{
					ctor: '::',
					_0: _w0rm$elm_flatris$View$renderWell(model),
					_1: {
						ctor: '::',
						_0: _w0rm$elm_flatris$View$renderControls,
						_1: {
							ctor: '::',
							_0: _w0rm$elm_flatris$View$renderPanel(model),
							_1: {
								ctor: '::',
								_0: _w0rm$elm_flatris$View$renderInfo(model.state),
								_1: {
									ctor: '::',
									_0: _w0rm$elm_flatris$View$renderWinner(model),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _w0rm$elm_flatris$Main$key = F3(
	function (on, _p0, keycode) {
		var _p1 = _p0;
		var _p2 = keycode;
		switch (_p2) {
			case 37:
				return _w0rm$elm_flatris$Actions$MoveLeft(on);
			case 39:
				return _w0rm$elm_flatris$Actions$MoveRight(on);
			case 40:
				return _w0rm$elm_flatris$Actions$Accelerate(on);
			case 38:
				return _w0rm$elm_flatris$Actions$Rotate(on);
			default:
				return _w0rm$elm_flatris$Actions$Noop;
		}
	});
var _w0rm$elm_flatris$Main$stateToAction = F2(
	function (model, state) {
		if (model.multiplayer) {
			var _p3 = state;
			switch (_p3) {
				case 'paused':
					return _w0rm$elm_flatris$Actions$Pause;
				case 'playing':
					return _w0rm$elm_flatris$Actions$Resume;
				case 'stopped':
					return _w0rm$elm_flatris$Actions$Stop;
				default:
					return _w0rm$elm_flatris$Actions$Noop;
			}
		} else {
...
var _w0rm$elm_flatris$Main$checkState = function (flag) {
	return flag ? _w0rm$elm_flatris$Actions$Resume : _w0rm$elm_flatris$Actions$Wait;
};
var _w0rm$elm_flatris$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$core$Native_Utils.eq(model.state, _w0rm$elm_flatris$Model$Playing) ? _elm_lang$animation_frame$AnimationFrame$diffs(_w0rm$elm_flatris$Actions$Tick) : _elm_lang$core$Platform_Sub$none,
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$ups(
					A2(_w0rm$elm_flatris$Main$key, false, model)),
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$downs(
						A2(_w0rm$elm_flatris$Main$key, true, model)),
					_1: {
						ctor: '::',
						_0: _w0rm$elm_flatris$Port$onStateChanged(
							_w0rm$elm_flatris$Main$stateToAction(model)),
						_1: {
							ctor: '::',
							_0: _w0rm$elm_flatris$Port$responseCheckState(_w0rm$elm_flatris$Main$checkState),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _w0rm$elm_flatris$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _w0rm$elm_flatris$Model$initial,
			_1: A2(
				_elm_lang$core$Task$perform,
				_elm_lang$core$Basics$always(_w0rm$elm_flatris$Actions$Init),
				_elm_lang$core$Task$succeed(0))
		},
		update: _w0rm$elm_flatris$Update$update,
		view: _w0rm$elm_flatris$View$view,
		subscriptions: _w0rm$elm_flatris$Main$subscriptions
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _w0rm$elm_flatris$Main$main !== 'undefined') {
    _w0rm$elm_flatris$Main$main(Elm['Main'], 'Main', undefined);
}
